...
This online shopping system is built using **PHP**, **MySQL**, and **CSS** for styling. It includes both **Admin** and **User** dashboards, with different features based on the role:
